...
public class Magician extends Commoner {
	...
	public void hunt() {
		...
		// 현재 원하는 것은 현재 hp값에서 2가 깎인 값이 새로운 hp로 저장되는것입니다.
		// setter와 getter(setHp(), getHp())를 적절히 활용해
		// 전투할때마다 체력이 2씩 깎이도록 로직을 작성해주세요.
		//getHp();
		setHp(getHp() - 2); // 괄호가 있으면 괄호 안쪽부터 접근하고 시작한다.
		// 경험치도 마찬가지로
		// exp += 10; 을 직접 실행할 수 없으므로
		// setExp()를 활용합니다.
		// 현재 원하는 것은, 현 exp값에서 사냥시마다 10씩 경험치가 증가하는것입니다.
		setExp(getExp() + 10);
	}
